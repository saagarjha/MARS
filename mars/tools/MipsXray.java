...
public class MipsXray extends AbstractMarsToolAndApplication {
	 ...
	 */
		...
		public void printTextDtoU(Vertex v) {
			...
			if (instructionCode.substring(0, 6).matches("101[0-1][0-1][0-1]") && !instructionCode.substring(0, 6).matches("0001[0-1][0-1]") && !instructionCode.substring(0, 6).matches("00001[0-1]")) { //load instruction
